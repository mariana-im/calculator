        ...
        def ley_cos_2():
              while True:
                try:
                  ...
                  if opcionangulo == 1:
                      angulo = math.acos(((-ladoa*2) + (ladob2) + (ladoc*2)) / (2*ladob*ladoc))
                      x = angulo*180/math.pi # Conversión de radianes a grados
                      return(x)
                
                  # Cálculo del ángulo B
                  elif opcionangulo == 2:
                      angulo = math.acos(((-(ladob*2) + (ladoa2) + (ladoc*2)) / 2*ladoa*ladoc))
                      x = angulo*180/math.pi
                      return(x)

                  # Cálculo del ángulo C
                  elif opcionangulo == 3:
                      angulo = math.acos(((-(ladoc*2) + (ladoa2) + (ladob*2)) / 2*ladoa*ladob))
                      x = angulo*180/math.pi
                      return(x)
                except ValueError:
                  print("El valor que ingresaste no es valido")
